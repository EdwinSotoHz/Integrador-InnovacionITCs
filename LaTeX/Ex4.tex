...
Dentro de un bloque try se validan los datos, usuario tiene condiciones hacerca del numero a convertir, el numero debe ser solo entero ya sea positivo o negativo entre el rango de 64 bits, dependiendo su valor va a imprimirlo de acuerdo al numero ingresado.
...
\begin{javaCode}
   public static void main(String[] args) {
        ...
        try {
            ...
            String input = decimal.nextLine();

            // Convierte la variable a un número de tipo long 
            numeroDecimal = Long.parseLong(input);
...
En caso contrario que el usuario haya tecleado un numero diferente al solicitado debe de caer en el bloque catch, donde si se encuentra fuera del rango o sea otro tipo de valor va a arrojar una excepción.
...
\begin{javaCode}
    //Excepción en caso de no encontrase en el rango solicitado
        ...
        // Excepciones en caso de ingresar un valor no válido 

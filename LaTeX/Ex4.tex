...
\begin{itemize}
    ...
    \begin{figure}
        \centerline{\includegraphics[width=18.5pc]{./latex-imagenes/diagramaDecimalABinarioPositivo.png}}
        ...
        \begin{figure}
            \centerline{\includegraphics[width=18.5pc]{./latex-imagenes/diagramaDecimalABinarioNegativo.png}}
